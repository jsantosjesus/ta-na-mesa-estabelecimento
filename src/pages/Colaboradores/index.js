      ...
      <div className="modalTransparent">
        <div className="poupupcolaborador">
          <div className="titleproduto">
            <h3>{object.nome}</h3>
            <button className="fecharColaborador" onClick={handleClose}>
              X
            </button>
            <hr />
          </div>
          ...
          <div className="corpoProduto">
            <forms>
              ...
              <div className="salvar">
                <button className="botaoSalvarProduto" onClick={salvar}>
                  Salvar Alterações
                </button>
              </div>
            </forms>
          ...
          <div id={mesasGarcom} className="modalTransparentMesas">
            <div className="mesasColaborador">
              <div className="titleMesasGarcom">
                ...
                <p onClick={fecharMesasGarcom} className="fecharMesas">
                  X
                </p>
              </div>
              <div className="bodyMesasGarcom">
                {table.map((table) => {
                  {
                    table.garcomId === object.nome
                      ? (table.mesaGarcom = true)
                      : (table.mesaGarcom = false);
                  }
                  ...
                  return (
                    <div
                      style={{ border: table.mesaGarcom ? 'solid 4px #3520bd' : 'solid 1px black' }}
                      className="mesaGarcom"
                      key={table.id}>
                      {table.numero}
              ...
              <div className="footermesasGarcom">
                <p onClick={fecharMesasGarcom}>Cancelar</p>
                <button onClick={salvarMesasGarcom}>Salvar</button>
              </div>
            </div>
          </div>
        </div>
